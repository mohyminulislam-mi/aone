...
import { normalizeCategories, normalizeProducts } from '@/lib/api-data';
  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        ...
        setProducts(normalizeProducts(prodRes));
      } catch (_error) {
        setCategories([]);
        setProducts([]);
      } finally {
...
function ProductsLoading() {
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="h-6 bg-secondary animate-pulse rounded w-40 mb-6" />
